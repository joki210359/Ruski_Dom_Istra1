...
@endforeach
    ...
    <footer>
        ...
        {{-- view post modal --}}
        <button class="text-slate-500/90 text-sm font-medium"> Просмотреть все 456 комментариев </button>

        {{-- leave comment --}}
        <form x-data="{inputText:''}" class="grid grid-cols-12 items-center w-full">
            @csrf

            <input x-model="inputText" type="text" placeholder=" Оставить комментарий "

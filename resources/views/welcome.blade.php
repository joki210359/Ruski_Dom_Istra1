...
<head>
    ...
    <!--<title>Laravel</title>
    <title>Ruski_Dom_Pula - @yield('title')</title>-->
    ...
    <style>
        ...
        *,
        ...
        .text-xl {
            font-size: 2.25rem;
            line-height: 1.75rem margim: 0 0 0 0;
        }
...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    <div class="bg-gray-50 text-black/50 dark:bg-black dark:text-white/50">
        <img id="background" class="absolute -left-20 top-0 max-w-[877px]  pointer-events-none"
            src="{{asset('assets/svgimage.svg')}}" />
        <!--<img src="{{asset('assets/svgimage.svg')}}"-->
        <div
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                    <div class="flex lg:justify-center lg:col-start-2">
                        ...
                        <img src="{{asset('assets/Ruski dom Istra logo.png')}}" class="rounded-md px-4 py-4"
                ...
                <main class="mt-6">
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        ...
                        <a id="docs-card"
                            class="flex flex-col items-start gap-6 overflow-hidden rounded-lg bg-white p-4
...
">
                            ...
                            <div class="relative flex items-center gap-6 lg:items-end">
                                <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                    ...
                                    <div class="pt-3 sm:pt-5 lg:pt-0">
                                        <h2 class="text-xl1 font-semibold text-black dark:text-white">Предупреждение
                                        </h2>

                                        <p class="mt-4 text-sm/relaxed">
                                        <div class="note">
                                            Запрещено размещать посты с политическими посланиями и взглядами, а также
                                            посты,
                                            поощряющие
                                            религиозную,
                                            расовую и национальную нетерпимость!!!
                                        </div>
                                        </p>
                                    </div>
                                </div>
                        ...
                        <a class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70
                    dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]" style="height: 160px;">
                            <div
                                class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                <svg class="size-5 sm:size-6" xmlns="http://www.w3.org/2000/svg" fill="none"
                                    viewBox="0 0 24 24">
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Что нового</h2>
                                <h3>Посмотрите, что происходит в мире прямо сейчас</h3>
                        ...
                        <a <a class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800
                    dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]"
                            ...
                            <div class="pt-3 sm:pt-5">
                                <h2 class="text-xl font-semibold text-black dark:text-white">Что нового в Истрии</h2>

                                <div class="features-div">
                                    <!-- <img class="twt-icon" src="https://image.ibb.co/bzvrkp/search_icon.png">-->
                                    <!--  <img class="twt-icon" src="images/1favigon.jpg">-->
                                    <p>Следуйте своим интересам.</p>
                                    <!-- <img class="twt-icon" src="https://image.ibb.co/mZPTWU/heart_icon.png">-->
                                    <p>Послушайте, о чем говорят люди.</p>
                                    <!--<img class="twt-icon" src="https://image.ibb.co/kw2Ad9/conv_icon.png">-->
                                    <p>Присоединиться к разговору.</p>
                                </div>
                            </div>
                ...
                <footer class="py-16 text-center text-sm text-black dark:text-white/70">
                    <section class="bg-red-100 p-0 m-1">
                        <div class="flex items-center justify-center">
                            <h3 class="text-gray-800/90 mt-2 text-sm text-center">
                                Русский Дом "Истрия" &#169; 2024 Все права защищены<br>

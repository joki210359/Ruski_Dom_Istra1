...
class ResetPassword extends Notification
{
    ...
    protected function buildMailMessage($url)
    {
        return (new MailMessage)
            ...
            ->line(Lang::get('Срок действия этой ссылки для сброса пароля истекает через :count minutes.', ['count' => config('auth.passwords.'.config('auth.defaults.passwords').'.истекает')]))
